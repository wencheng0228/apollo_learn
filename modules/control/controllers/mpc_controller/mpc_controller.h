 ...
 */
class MPCController : public ControlTask {
public:
    /**
     * @brief constructor
     */
...
protected:
    ...
    const int basic_state_size_ = 6;  // 默认值为6

    const int controls_ = 2;  // 默认值为2
    ...
    // control matrix
    Eigen::MatrixXd matrix_b_;  // 6x2
    // control matrix (discrete-time)
    Eigen::MatrixXd matrix_bd_;  // 6x2
...
// 1.2 当前类声明为插件
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(apollo::control::MPCController, ControlTask)
